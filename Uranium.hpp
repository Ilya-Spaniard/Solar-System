...
public:
  ...
  Uranium(int x_val = 980, int y_val = 540, int radius_val = 50, int n_distance = 100, double rotation_val = 0.5, double speed_val = 0.5, string n_name = "uranium.jpg")
  {
